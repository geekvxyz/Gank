 ...
 */
public class JSFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView(View view) {
        ...
        HttpUtils.getqdArticles(1,new Response.Listener<String>() {
            @Override
    ...
    private void loadPage(int page) {
        ...
        HttpUtils.getqdArticles(page, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                final List<Article.Results> list;
                Article article = new Gson().fromJson(s, Article.class);
